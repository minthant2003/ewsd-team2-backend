    ...
    public function run(): void
    {
        ...
        $ideas = [
            ...
            [
                ...
                'content' => 'Propose implementing virtual lab infrastructure to allow students to access laboratory resources remotely, enabling flexible learning and reducing physical space constraints.',
                'is_anonymous' => false,
                'view_count' => 45,
                'popularity' => 17,
                'user_id' => 2, // Sarah Wilson
                'academic_year_id' => 3,
                'category_id' => 2,
                'remark' => 'Proposed by Engineering Department',
                'report_count' => 0,
                'is_hidden' => false,
            ],
            [
                'title' => 'Student Mental Health Support Program',
                'content' => 'Develop a comprehensive mental health support program including counseling services, stress management workshops, and peer support groups to improve student wellbeing.',
                'is_anonymous' => false,
                'view_count' => 52,
                'popularity' => 21,
                'user_id' => 3, // Michael Chen
            ...
            [
                ...
                'content' => 'Create an online platform to facilitate research collaboration between departments, allowing for better resource sharing, project management, and knowledge exchange.',
                'is_anonymous' => false,
                'view_count' => 38,
                'popularity' => 15,
                'user_id' => 7, // David Lee
            ...
            [
                'title' => 'Sustainable Campus Transportation',
                'content' => 'Implement a sustainable transportation system including bike-sharing programs, electric vehicle charging stations, and improved public transit access to reduce carbon emissions.',
                'is_anonymous' => false,
                'view_count' => 41,
                'popularity' => 16,
                'user_id' => 8, // Sophia Rodriguez
            ...
            [
                'title' => 'Digital Learning Resources Hub',
                'content' => 'Create a centralized digital hub for learning resources, including e-books, video lectures, and interactive materials to enhance student learning experiences.',
                'is_anonymous' => false,
                'view_count' => 34,
                'popularity' => 12,
                'user_id' => 5, // Alex Thompson
            ...
            [
                'title' => 'Faculty Research Grant Program',
                'content' => 'Establish a structured grant program to support faculty research initiatives, including seed funding, travel grants, and equipment acquisition support.',
                'is_anonymous' => false,
                'view_count' => 29,
                'popularity' => 10,
                'user_id' => 9, // Robert Johnson
                'academic_year_id' => 4,
                'category_id' => 6,
                'remark' => 'Proposed by Computer Science Department',
                'report_count' => 0,
            ...
            [
                'title' => 'Campus Digital Transformation Initiative',
                'content' => 'Propose a comprehensive digital transformation plan for the university, including smart classrooms, digital signage, and IoT integration for better campus management.',
                'is_anonymous' => false,
                'view_count' => 56,
                'popularity' => 23,
                'user_id' => 1, // John Doe
            ...
            [
                ...
                'content' => 'Develop an analytics platform to track student performance, identify at-risk students, and provide data-driven insights for academic support services.',
                'is_anonymous' => false,
                'view_count' => 48,
                'popularity' => 19,
                'user_id' => 3, // Michael Chen
            ...
            [
                ...
                'content' => 'Propose an annual sustainability report initiative to track and improve our environmental impact, including energy usage, waste management, and carbon footprint.',
                'is_anonymous' => false,
                'view_count' => 42,
                'popularity' => 17,
                'user_id' => 8, // Sophia Rodriguez
        ...
        $ideaDocuments = [
            ...
            [
                'idea_id' => 16, // Campus Digital Transformation Initiative
                'file_name' => 'idea_documents/file-sample_150kB.pdf',
                'public_file_url' => '/storage/idea_documents/file-sample_150kB.pdf',
                'remark' => 'Detailed technical proposal with implementation timeline',
            ],
            [
                'idea_id' => 16,
                'file_name' => 'idea_documents/university-5188610_1280.jpg',
                'public_file_url' => '/storage/idea_documents/university-5188610_1280.jpg',
                'remark' => 'Architecture diagram for smart campus implementation',
            ],
            [
                'idea_id' => 17, // Student Success Analytics Platform
                'file_name' => 'idea_documents/library-1400313_1280.jpg',
                'public_file_url' => '/storage/idea_documents/library-1400313_1280.jpg',
                'remark' => 'System architecture and user interface design',
            ],
            [
                'idea_id' => 17,
                'file_name' => 'idea_documents/file-sample_150kB.pdf',
                'public_file_url' => '/storage/idea_documents/file-sample_150kB.pdf',
                'remark' => 'Detailed metrics and KPIs for student success tracking',
            ],
            [
                'idea_id' => 18, // Campus Sustainability Report
                'file_name' => 'idea_documents/college-75535_1280.jpg',
                'public_file_url' => '/storage/idea_documents/college-75535_1280.jpg',
                'remark' => 'Report template with data collection methodology',
            ],
            [
                'idea_id' => 18,
                'file_name' => 'idea_documents/file-sample_150kB.pdf',
                'public_file_url' => '/storage/idea_documents/file-sample_150kB.pdf',
                'remark' => 'Comprehensive environmental impact assessment',
            ],
        ];
